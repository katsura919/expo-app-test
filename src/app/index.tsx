...
const INITIAL_TASKS = [
  ...
  { id: 2, text: "Build auth screens", done: true },
  { id: 3, text: "Set up Supabase auth", done: false },
  { id: 4, text: "Create dashboard UI", done: false },
        ...
        >
          ...
          >
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
              ...
              >
                <LogOut size={18} color={C.black} strokeWidth={3} />
              </Pressable>
            </View>
          </Animated.View>
